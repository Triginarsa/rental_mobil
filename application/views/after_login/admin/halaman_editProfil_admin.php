    ...
    <html lang="en">
        ...
        <!-- Preloader - style you can find in spinners.css -->
            ...
            <div class="card_edit2 col-lg-9">
                <div class="card">
                    <div class="card-body"> 
                        <center> 
                            ...
                            <span>Ini halaman edit profil Admin! </span>
                        </center>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                     <form class="form-valide" enctype='multipart/form-data' action="<?php echo base_url('c_beranda_admin/updateAdmin');?>" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <button type="submit" name="btnUpdate" value="update" class="btn col-lg-4 btn-info">Edit</button>
                                                 <a href="<?php echo base_url('c_beranda_admin/index/'.$this->session->userdata('id')); ?>" class="btn col-lg-3 btn-warning" onclick="return confirm('Apakah anda yakin tidak melakukan edit?');">Cancel</a>
                                            </div>
                                            <!--/span-->
                                        </div>
                                            <!--/span-->
