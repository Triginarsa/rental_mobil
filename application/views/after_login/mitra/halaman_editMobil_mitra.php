        ...
        <!-- Preloader - style you can find in spinners.css -->
            ...
            <div class="card_edit2 col-lg-9"><!--mengganti ukuran form-->
                <div class="card card-outline-primary">
                    <div class="card-body">
                        <form class="form-valide" action="<?php echo base_url('c_beranda_mitra/updateMobil/'.$mobils->id_mobil);?>" method="post">
                            ...
                            <div class="form-body">
                                <div class="row p-t-20">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                            <button type="submit" name="btnUpdate" value="update" class="btn col-lg-3 btn-success">EDIT</button>
                                            <button type="submit" name="btnCancel" value="CANCEL" class="btn col-lg-3 btn-default">CANCEL</button>
                                        </div>
                                        <!--/span-->
                                    </div>
                                        <!--/span-->
